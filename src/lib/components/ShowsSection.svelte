...
<section id="shows" class="section py-20 relative">
  ...
  <div
    class="absolute inset-0 bg-cover bg-no-repeat bg-center opacity-0 sm:opacity-60 grayscale"
    style="background-image: url('/images/live.webp')"
  ></div>
  <div
    ...
    >
      ...
      <div class="mb-10">
        <p class="text-white max-w-3xl text-lg">
          Sprawdź gdzie możesz nas zobaczyć na żywo w najbliższym czasie. Nasze
          koncerty to zawsze potężna dawka energii i niezapomniane wrażenia!
        </p>
      </div>
        ...
        {#each upcomingShows as show, i}
          ...
          >
            <div class="flex justify-between mb-4">
              <div>
                <h3
                  class="text-2xl font-heading text-white group-hover:text-accent-red transition-colors"
                >
                  {show.city}
                </h3>
              ...
              <div
                class="bg-gray-800 px-3 py-2 rounded relative overflow-hidden group-hover:bg-accent-red/20 transition-colors min-w-[100px] flex items-center justify-center"
              >
                <span
                  class="text-white font-medium relative z-10 text-center whitespace-pre-line"
                  >{show.date}</span
                >
              </div>
            </div>
            <div class="mt-auto pt-4 flex justify-end items-center gap-3">
              ...
              <a
                ...
                target="_blank"
                rel="noopener noreferrer"
                class="btn text-sm py-2 px-4 border-accent-red text-accent-red hover:text-black"
                >{show.ticketText}</a
              >
            </div>
          </div>
      ...
      <div class="mt-12 text-center">
        <div class="relative inline-block group">
          <a
            href="#contact"
            class="btn border-accent-red text-accent-red hover:text-black"
            >Zabookuj koncert</a
          >
          <div
            class="absolute -inset-0.5 bg-accent-red opacity-0 group-hover:opacity-30 blur transition duration-500 rounded-sm"
          ></div>
        </div>
      </div>
    </div>
